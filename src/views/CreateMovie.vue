...
// se deja un modelo del objeto que se estaria añadiendo al json el cual estaria con la información obtenida del formulario
let newMovie = {
  id: 11,
  name: "Barbie",
...
const addMovie = () => {
  ...
  alert("pelicula añadida en el localstorage")
}
</script>
...
<template>
  <div class="w-full h-full flex justify-center my-20">
    <div class="bg-gray-300 dark:bg-slate-700 p-4 rounded-lg h-full  w-[80%]">
      <form class="w-full lg:grid lg:grid-cols-2 flex flex-col gap-4">
        <div class="-mx-3 mb-6 flex flex-col gap-2">
          <div class="w-full px-3 mb-6 md:mb-0">
            ...
            <input
              class="dark:bg-gray-700 dark:border-gray-600 appearance-none block w-full bg-gray-50 border   rounded py-3 px-4 mb-3 leading-tight focus:outline-none "
              id="grid-first-name" type="text" placeholder="Titulo de la pelicula">
          </div>
          ...
          <div class="w-full flex">
            ...
            <div class="w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                class="dark:bg-gray-700 dark:border-gray-600 appearance-none block w-full   border  rounded py-3 px-4 leading-tight focus:outline-none  "
        ...
        <div class="flex flex-wrap lg:mx-3 mb-6">
          ...
          <div class="w-full">
            ...
            <textarea id="sinopsis" rows="4"
              class="block p-2.5 w-full h-full text-sm text-gray-900  rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div class="lg:col-span-2 flex justify-center m-4">
        <button @click="addMovie"
          class="bg-blue-500 dark:bg-blue-950 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
          Crear Pelicula
        </button>
      </div>
